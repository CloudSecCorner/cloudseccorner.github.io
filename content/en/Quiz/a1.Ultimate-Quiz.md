...
1. [ ] Possession, ownership, control 
1. [ ] Ownership, use, creation 
1. [ ] Control, custody, use 
1. [x] Possession, custody, control 
...
1. [x] Volume and object 
1. [ ] Volume and database 
...
1. [x] Inter-cloud provider
1. [ ] Cloud service business manager 
1. [ ] Cloud service administrator
...
1. [ ] Take a shapshot of the virtual machines 
1. [ ] Escrow the encryption keys 
1. [ ] Copy the data 
